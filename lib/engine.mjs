...
export async function measureUrl(target) {
  ...
  try {
    ...
    return { unavailable: true, floorMs: a.floorMs, message: `Live render isn’t enabled on this deployment — measure ${a.domain} with the CLI:  npx lightsout ${a.domain} --fcp` };
  }
}
